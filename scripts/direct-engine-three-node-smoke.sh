...
run_id="${2:-$$-${RANDOM}}"
network="r1db-direct-${run_id}"
tmp="$(mktemp -d /tmp/r1db-direct.XXXXXX)"
nodes=("r1db-direct-1-${run_id}" "r1db-direct-2-${run_id}" "r1db-direct-3-${run_id}")
volumes=("r1db-direct-store-1-${run_id}" "r1db-direct-store-2-${run_id}" "r1db-direct-store-3-${run_id}")
