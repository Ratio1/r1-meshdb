...
import (
	...
	autoconfigpb "github.com/cockroachdb/cockroach/pkg/server/autoconfig/autoconfigpb"
	github_com_cockroachdb_cockroach_pkg_server_autoconfig_autoconfigpb "github.com/cockroachdb/cockroach/pkg/server/autoconfig/autoconfigpb"
...
type RestoreDetails struct {
	...
	// Removes regions.
	RemoveRegions bool `protobuf:"varint,31,opt,name=RemoveRegions,proto3" json:"RemoveRegions,omitempty"`
}
...
func (*SchemaChangeGCProgress_TableProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c315f3a2536c4ef, []int{32, 1}
}
...
func (*SchemaChangeGCProgress_TenantProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c315f3a2536c4ef, []int{32, 2}
}
...
type AutoConfigEnvRunnerDetails struct {
	EnvID github_com_cockroachdb_cockroach_pkg_server_autoconfig_autoconfigpb.EnvironmentID `protobuf:"bytes,1,opt,name=env_id,json=envId,proto3,casttype=github.com/cockroachdb/cockroach/pkg/server/autoconfig/autoconfigpb.EnvironmentID" json:"env_id,omitempty"`
}
...
type AutoConfigTaskDetails struct {
	EnvID github_com_cockroachdb_cockroach_pkg_server_autoconfig_autoconfigpb.EnvironmentID `protobuf:"bytes,1,opt,name=env_id,json=envId,proto3,casttype=github.com/cockroachdb/cockroach/pkg/server/autoconfig/autoconfigpb.EnvironmentID" json:"env_id,omitempty"`
	Task  autoconfigpb.Task                                                                 `protobuf:"bytes,2,opt,name=task,proto3" json:"task"`
}
...
var fileDescriptor_6c315f3a2536c4ef = []byte{
	// 8853 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *StreamReplicationProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n10, err10 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Expiration, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.Expiration):])
	if err10 != nil {
		return 0, err10
	}
	i -= n10
...
func (m *BackupDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ResolvedCompleteDbs) > 0 {
		dAtA13 := make([]byte, len(m.ResolvedCompleteDbs)*10)
		var j12 int
...
func (m *ImportProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ResumePos) > 0 {
		dAtA36 := make([]byte, len(m.ResumePos)*10)
		var j35 int
	...
	if len(m.WriteProgress) > 0 {
		for iNdEx := len(m.WriteProgress) - 1; iNdEx >= 0; iNdEx-- {
			f37 := math.Float32bits(float32(m.WriteProgress[iNdEx]))
			i -= 4
	...
	if len(m.ReadProgress) > 0 {
		for iNdEx := len(m.ReadProgress) - 1; iNdEx >= 0; iNdEx-- {
			f38 := math.Float32bits(float32(m.ReadProgress[iNdEx]))
			i -= 4
			encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(f38))
		}
	...
	if len(m.SamplingProgress) > 0 {
		for iNdEx := len(m.SamplingProgress) - 1; iNdEx >= 0; iNdEx-- {
			f39 := math.Float32bits(float32(m.SamplingProgress[iNdEx]))
			i -= 4
...
func (m *BackfillProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DestIndexIDs) > 0 {
		dAtA42 := make([]byte, len(m.DestIndexIDs)*10)
		var j41 int
...
func (m *SchemaChangeDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DroppedFunctions) > 0 {
		dAtA47 := make([]byte, len(m.DroppedFunctions)*10)
		var j46 int
	...
	if len(m.DroppedSchemas) > 0 {
		dAtA50 := make([]byte, len(m.DroppedSchemas)*10)
		var j49 int
	...
	if len(m.DroppedTypes) > 0 {
		dAtA52 := make([]byte, len(m.DroppedTypes)*10)
		var j51 int
...
func (m *CreateStatsDetails_ColStat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColumnIDs) > 0 {
		...
		i = encodeVarintJobs(dAtA, i, uint64(j65))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RowLevelTTLDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n68, err68 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Cutoff, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.Cutoff):])
	if err68 != nil {
		return 0, err68
	}
	i -= n68
	i = encodeVarintJobs(dAtA, i, uint64(n68))
	i--
	dAtA[i] = 0x12
	if m.TableID != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.TableID))
...
func (m *AutoConfigEnvRunnerDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EnvID) > 0 {
		i -= len(m.EnvID)
		copy(dAtA[i:], m.EnvID)
		i = encodeVarintJobs(dAtA, i, uint64(len(m.EnvID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Payload) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DescriptorIDs) > 0 {
		dAtA73 := make([]byte, len(m.DescriptorIDs)*10)
		var j72 int
		...
		i = encodeVarintJobs(dAtA, i, uint64(j72))
		i--
		dAtA[i] = 0x32
	}
...
func (m *AutoConfigEnvRunnerDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.EnvID = github_com_cockroachdb_cockroach_pkg_server_autoconfig_autoconfigpb.EnvironmentID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipJobs(dAtA[iNdEx:])
