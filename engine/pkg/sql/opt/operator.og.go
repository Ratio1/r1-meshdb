...
func IsScalarOp(e Expr) bool {
	...
	case AggDistinctOp, AggFilterOp, AggregationsOp, AggregationsItemOp,
		...
		MaxOp, MergeStatementStatsOp, MergeStatsMetadataOp, MergeTransactionStatsOp, MinOp,
...
func IsAggregateOp(e Expr) bool {
	...
	case AnyNotNullAggOp, ArrayAggOp, ArrayCatAggOp, AvgOp,
		...
		JsonbAggOp, JsonbObjectAggOp, MaxOp, MergeStatementStatsOp, MergeStatsMetadataOp,
		MergeTransactionStatsOp, MinOp, PercentileContOp, PercentileDiscOp, RegressionAvgXOp,
		RegressionAvgYOp, RegressionCountOp, RegressionInterceptOp, RegressionR2Op, RegressionSXXOp,
