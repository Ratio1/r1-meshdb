...
var demoCmd = &cobra.Command{
	...
	Long: `
Start an in-memory, standalone, single-node R1DB instance, and open an
...
# Welcome to the R1DB demo database!
#
# You are connected to a temporary, in-memory R1DB cluster of %d node%s.
